...
const submissionRulesEmbedDescription = "**1.** All submissions must be posted using /submit-pb.\n" +
	...
	"**5.** Raid PBs will be based on the overall time taken to complete, as broadcasted.\n\n" +
	"**6.** Evidence must include everything needed to validate the run. For group bosses or raids, show the time and a clear view or list of participants.\n\n" +
	"**7.** All submissions must include your RSN and be a full-screen picture, especially for team submissions."
